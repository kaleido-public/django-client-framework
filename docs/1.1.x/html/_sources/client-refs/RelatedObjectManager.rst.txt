...
--------------------------
    ...
    setting the foreign id directly on the parent. It sends a ``PATCH`` request to
    the server.
    ...
    .. tabs::
        ...
        .. code-tab:: ts
            ...
            let brand: ObjectManager<Brand> = ...
            product.brand.set(brand)
            // PATCH /product/<id>/brand "4da0cde7-8341-46d3-9b4c-4eafa48d8a81"
