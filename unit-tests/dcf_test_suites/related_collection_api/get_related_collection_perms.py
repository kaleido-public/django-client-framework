...
class TestPaginationPerms(TestCase):
    ...
    def test_no_permissions_get(self) -> None:
    ...
    def test_only_parent_permissions_get(self) -> None:
    ...
    def test_only_parent_permissions_get_2(self) -> None:
        p.add_perms_shortcut(self.user, Brand, "r", field_name="products")
    ...
    def test_correct_parent_incorrect_reverse_perms_get(self) -> None:
        p.add_perms_shortcut(self.user, Brand, "r", field_name="products")
    ...
    def test_get_with_object_level_perm(self) -> None:
        p.add_perms_shortcut(self.user, Brand, "r", field_name="products")
