...
class Searchable(DjangoModel, ISearchable):
    ...
    def _get_text_feature(self) -> str:
    ...
    def get_or_create_searchfeature(self) -> Tuple[SearchFeature, bool]:
    ...
    def update_or_create_searchfeature(self) -> Tuple[SearchFeature, bool]:
    ...
    @classmethod
    def update_all_search_feature(cls) -> None:
        for instance in cls.objects.all():
            cast(Searchable, instance).update_or_create_searchfeature()


@receiver(post_save)
def update_searchfeature_on_change(sender: Any, instance: Any, **kwargs: Any) -> None:
    """
